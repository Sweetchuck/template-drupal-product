...
$databases = [
  'default' => [
    'default' => [
      'driver' => 'mysql',
      'username' => getenv('MYSQL_USER') ?: getenv('USER') ?: '',
      'password' => getenv('MYSQL_PASSWORD') ?: 'admin',
      'host' => getenv('MYSQL_HOST') ?: '127.0.0.1',
      'port' => getenv('MYSQL_PORT') ?: 3306,
      'prefix' => '',
      'database' => getenv('MYSQL_DATABASE') ?: 'APP_PROJECT_VENDOR_SNAKE__APP_PROJECT_NAME_SNAKE__default',
      'collation' => 'utf8mb4_general_ci',
      'init_commands' => [
